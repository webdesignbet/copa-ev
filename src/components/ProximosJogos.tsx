      ...
      <div className="relative w-full">
        ...
        >
          {duplicated.map((jogo, i) => (
            <div
              key={`${jogo.id}-${i}`}
              className="min-w-[240px] sm:min-w-[270px] md:min-w-[300px] rounded-2xl shadow-lg bg-white/30 dark:bg-gray-800/30 backdrop-blur-md border border-red-200 dark:border-red-700 p-3 flex flex-col items-center transition hover:scale-[1.02] hover:border-red-400 dark:hover:border-red-500"
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-base font-semibold cursor-default" title={jogo.mandante}>
                    {jogo.siglaMandante}
                  </span>
                </div>
